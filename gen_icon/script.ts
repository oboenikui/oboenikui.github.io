...
var setupCanvas = (imageData: string) => {
    ...
    image.addEventListener("load", function () {
        ...
        var padding: number = (<HTMLInputElement>document.getElementById("padding")).valueAsNumber;
...
var changeColorType = (e: Event) => {
    ...
    var padding: HTMLInputElement = <HTMLInputElement>document.getElementById("padding");
...
var changeIconType = (e: Event) => {
    ...
    var x: HTMLInputElement = <HTMLInputElement>document.getElementById("size_x");
    var y: HTMLInputElement = <HTMLInputElement>document.getElementById("size_y");
    var design_type: string = (<HTMLInputElement>document.getElementById("color_type")).value;
    switch (value) {
        case "actionbar":
