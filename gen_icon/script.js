var CRC32 = (function () {
    ...
    CRC32.getCRC32 = function (buffer, crc32_start) {
        var crc = crc32_start;
...
var startColor = function () {
    document.getElementById("color_type").value = "custom";
    start();
};

var startSize = function () {
    document.getElementById("icon_type").value = "custom";
    start();
};
...
var setupCanvas = function (imageData) {
    var image = new Image();
    image.src = imageData;
    image.addEventListener("load", function () {
        var size_x = document.getElementById("size_x").valueAsNumber;
        ...
        var padding = document.getElementById("padding").valueAsNumber;
...
var changeColorType = function (e) {
...
var changeIconType = function (e) {
    var value = e.target.value;
    var x = document.getElementById("size_x");
    var y = document.getElementById("size_y");
    var design_type = document.getElementById("color_type").value;
    switch (value) {
        case "actionbar":
            if (design_type == "material_white" || design_type == "material_black") {
                x.value = "96";
                y.value = "96";
            } else {
                x.value = "128";
...
var createZip = function () {
    ...
    var file_name = document.getElementById("file_name").value + ".png";
    if (file_name.length == 4) {
...
var stoInt16Array = function (data) {
