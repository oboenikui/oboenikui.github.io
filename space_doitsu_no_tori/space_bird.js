...
var Space = (function () {
    ...
    Space.prototype.getGrabbingBird = function () {
        return this.grabbing_bird;
    };

    Space.prototype.removeGrabbingBird = function () {
        this.grabbing_bird = null;
    };
    ...
    Space.prototype.startAnimation = function () {
        ...
        this.mAnim = window.setInterval(function () {
            ...
            for (var i = 0; i < _this.birds.length; i++) {
                ...
                if (nv.x < -Space.MAX_RADIUS || nv.x > _this.boardWidth + Space.MAX_RADIUS || nv.y < -Space.MAX_RADIUS || nv.y > _this.boardHeight + Space.MAX_RADIUS) {
                    nv.reset();
                }
            }
        }, Space.TIMEOUT);
